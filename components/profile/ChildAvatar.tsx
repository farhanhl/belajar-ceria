...
export const AVATAR_LIST = [
  { id: "girl-1", label: "Gadis Hijab", bg: "bg-pink-100", border: "border-pink-400" },
  { id: "boy-1", label: "Laki-laki Hebat", bg: "bg-sky-100", border: "border-sky-400" },
  { id: "girl-2", label: "Gadis Kuncir", bg: "bg-purple-100", border: "border-purple-400" },
  { id: "boy-2", label: "Anak Bertopi", bg: "bg-emerald-100", border: "border-emerald-400" },
  { id: "girl-3", label: "Gadis Kacamata", bg: "bg-rose-100", border: "border-rose-400" },
  { id: "boy-3", label: "Jagoan Bandana", bg: "bg-blue-100", border: "border-blue-400" },
  { id: "girl-4", label: "Putri Bunga", bg: "bg-amber-100", border: "border-amber-400" },
  { id: "boy-4", label: "Kapten Cilik", bg: "bg-cyan-100", border: "border-cyan-400" },
  ...
  { id: "rabbit-1", label: "Kelinci Imut", bg: "bg-pink-100", border: "border-pink-400" },
  { id: "bear-1", label: "Beruang Cokelat", bg: "bg-amber-100", border: "border-amber-400" },
  { id: "panda-1", label: "Panda Gembul", bg: "bg-slate-100", border: "border-slate-400" },
  { id: "lion-1", label: "Singa Cilik", bg: "bg-orange-100", border: "border-orange-400" },
  { id: "frog-1", label: "Katak Riang", bg: "bg-emerald-100", border: "border-emerald-400" },
  { id: "fox-1", label: "Rubah Pintar", bg: "bg-orange-100", border: "border-orange-400" },
  { id: "dino-1", label: "Dino Hijau", bg: "bg-teal-100", border: "border-teal-400" },
  { id: "chick-1", label: "Ayam Cilik", bg: "bg-yellow-100", border: "border-yellow-400" },
];
